# genpark-multi-agent-collaborative-debug-orchestrator-skill
...
> **GenPark AI Agent Skill** -- Multi-agent collaborative bug reproduction & patch synthesizer (Muse Code style)
